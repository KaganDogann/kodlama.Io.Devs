...
namespace WebAPI.Controllers
{
    ...
    public class ProgrammingTechnologiesController : BaseController
    {
        ...
        [HttpPost("Delete/{Id}")]
        public async Task<ActionResult> Delete([FromRoute] DeleteProgrammingTechnologyCommand deleteProgrammingTechnologyByIdCommand, CancellationToken cancellationToken)
        {
